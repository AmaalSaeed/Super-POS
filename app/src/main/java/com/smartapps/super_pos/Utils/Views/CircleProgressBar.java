...
public class CircleProgressBar extends View {
    ...
    private int color = Color.parseColor("#a5287e");
    private RectF rectF;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            min = typedArray.getInt(R.styleable.CircleProgressBar_minValue, min);
            max = typedArray.getInt(R.styleable.CircleProgressBar_maxValue, max);
        } finally {
            typedArray.recycle();
        }
  ...
  /*     // Typeface plain = getResources().getFont(R.font.font);
        Paint paint = new Paint();
        paint.setTypeface(Typeface.create("Arial",Typeface.ITALIC));
        canvas.drawText("Sample text in bold",rectF.centerX(),rectF.centerY(),paint);*/
